...
//                .getSingleResult();
     ...
     */
    @Transactional(Transactional.TxType.REQUIRES_NEW)
    public List<UploadGroupInfo> findUploadGroupInfoBySendInfoId(String sendInfoId) {
        return rootEm.createNamedQuery(UploadGroupInfo.NAMED_QUEUE_FIND_BY_SENDINFOID, UploadGroupInfo.class)
                .setParameter("sendInfoId", sendInfoId)
                .getResultList();
    }
