...
$(function () {
    ...
    document.body.addEventListener('dragover', function (evt) {
        ...
        if (dragging === false) {
            ...
            var elm = document.getElementById('dispForm:tabViewSend:fileUploadArea');
            var type = document.getElementById('dispForm:tabViewSend:fileUploadAreaType');
            ...
            if (type !==null && type.value === '0') {
                ...
                _top = jQuery("#dispForm\\:tabViewSend\\:fileUploadArea").offset().top;
                _left = jQuery("#dispForm\\:tabViewSend\\:fileUploadArea").offset().left;
            }
    ...
    document.getElementById('dispForm:tabViewSend:fileUploadArea').addEventListener('dragover', function (evt) {
        stopDnDEvent(evt);
        countOver++;
