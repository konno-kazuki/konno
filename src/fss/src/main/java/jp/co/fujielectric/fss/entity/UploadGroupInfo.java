...
@NamedQueries({
    ...
    @NamedQuery(name = UploadGroupInfo.NAMED_QUEUE_FIND_BY_SENDINFOID, 
            query = "from UploadGroupInfo a where a.sendInfoId = :sendInfoId"),
})
public class UploadGroupInfo implements Serializable {
    ...
    public static final String NAMED_QUEUE_FIND_BY_SENDINFOID = "findBySnedinfoId";
