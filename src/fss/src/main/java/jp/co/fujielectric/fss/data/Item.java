...
public class Item {
    ...
    public static final String FUNC_DELETEREASON_DETAILS = "delete_reason_details";
    ...
    //履歴表示最大件数[v2.2.4]
    public static final Item HISTORY_ROW_MAX = new Item("historyRowMax", CONFIG);
    //履歴検索期間初期値[v2.2.4]
    public static final Item HISTORY_SEARCH_DAYS_DEFAULT = new Item("historySearchDaysDefault", CONFIG);
    
    //高圧縮ZIP対応 ZIP内ファイル数上限値[v2.2.5d]
    public static final Item ZIP_FILES_COUNT_LIMIT = new Item("ZipFilesCountLimit", CONFIG);
    //高圧縮ZIP対応 ZIP内ファイル解凍後サイズ上限値[v2.2.5d]
    public static final Item ZIP_FILES_SIZE_LIMIT = new Item("ZipFilesSizeLimit", CONFIG);

    //PDFファイルサイズ上限値（単位：MB)[v2.2.6]
    public static final Item PDF_FILE_SIZE_LIMIT = new Item("PDFFileSizeLimit", CONFIG);
    //Wordファイルサイズ上限値（単位：MB)[v2.2.6]
    public static final Item WORD_FILE_SIZE_LIMIT = new Item("WordFileSizeLimit", CONFIG);
    //Excelファイルサイズ上限値（単位：MB)[v2.2.6]
    public static final Item EXCEL_FILE_SIZE_LIMIT = new Item("ExcelFileSizeLimit", CONFIG);
    //PowerPointファイルサイズ上限値（単位：MB)[v2.2.6]
    public static final Item POWER_POINT_FILE_SIZE_LIMIT = new Item("PowerPointFileSizeLimit", CONFIG);
    ...
    public enum ErrMsgItemKey {
        ...
        /**
         * 上限を超えたZIPファイルのため送信されません。ZIPファイルに含まれるファイル数を%dファイル以下、合計のファイルサイズを%dMB以下としてください。
         */
        ERR_ZIP_BOMB_FILE("errZipBombFile"),
        
        /**
         * 上限を超えたPDFファイルです。PDFファイルにパスワードが付いている場合は削除されます。PDFファイルのファイルサイズを%dMB以下としてください。
         */
        ERR_FILE_SIZEOVER_PDF("errPDFFileSizeOver"),
        ERR_FILE_SIZEOVER_WORD("errWordFileSizeOver"),
        ERR_FILE_SIZEOVER_EXCEL("errExcelFileSizeOver"),
        ERR_FILE_SIZEOVER_POWERPOINT("errPowerPointFileSizeOver"),
        /**
         * 上限を超えたPDFファイルがZIPァイルに含まれます。PDFファイルにパスワードが付いている場合は削除されます。PDFファイルのファイルサイズを%dMB以下としてください。 
         */
        ERR_FILE_INZIP_SIZEOVER_PDF("errPDFFileInZipSizeOver"),
        ERR_FILE_INZIP_SIZEOVER_WORD("errWordFileInZipSizeOver"),
        ERR_FILE_INZIP_SIZEOVER_EXCEL("errExcelFileInZipSizeOver"),
        ERR_FILE_INZIP_SIZEOVER_POWERPOINT("errPowerPointFileInZipSizeOver"),
        /**
         * 無害化処理中のファイル送信があるため、連続してファイル送信を行うことができません。
         */
        ERR_FILE_SEND_TRANSFER_PROCESSING("errFileSendTransferProcessing"),
        ;
