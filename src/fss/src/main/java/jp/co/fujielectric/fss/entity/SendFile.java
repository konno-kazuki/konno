...
public class SendFile implements Serializable {
    ...
    /**
     * [v2.2.5d]
     * 高圧縮ZIPファイル（ZipBomb）かどうかを返す
     * @return 
     */
    @JsonIgnore
    public boolean isZipBomb(){
        //filePass="1"の場合にZipBompとしてTrueを返す
        return ("1".equals(filePass));
    }

    /**
     * [v2.2.5d]
     * 高圧縮ZIPファイル（ZipBomb）かどうかをセットする
     * @param isZipBomb 
     */
    @JsonIgnore
    public void setIsZipBomb(boolean isZipBomb){
        //filePass にZipBombかどうかをセットする。
        // "1":ZipBomb, "0":それ以外
        filePass = ( isZipBomb ? "1" : "0");
    }
