...
/**
 * [RESTful] sendrequestinfo
 */
@Stateless
@Path("sendrequestinfo")
public class SendRequestInfoFacadeREST extends AbstractFacade<SendRequestInfo> {

    @Inject
    private EntityManager em;

    public SendRequestInfoFacadeREST() {
        super(SendRequestInfo.class);
    }
